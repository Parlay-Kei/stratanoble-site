...
**File (legacy path):** `infra/supabase/migrations/0017_leads_table.sql`
**Canonical path (current):** `supabase/migrations/0016_phase_three_leads_table.sql`
...
**File (legacy path):** `infra/supabase/migrations/0018_email_sequences_table.sql`
**Canonical path (current):** `supabase/migrations/0017_phase_three_email_sequences.sql`
...
**File (legacy path):** `infra/supabase/migrations/0019_user_profiles_table.sql`
**Canonical path (current):** No longer relied on in production; admin access uses JWT claims.
...
npx supabase db push --project-ref bvneqoevtwodyfqglpzi
