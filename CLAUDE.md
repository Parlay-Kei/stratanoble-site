# CLAUDE.md — Strata Noble (Website + Platform)
...
├── achievery-mobile/ # Mobile app (separate)
...
8. **Offer architecture:** All pricing, positioning, and offer structure must conform to `C:\Dev\.claude-anx\docs\governance\SN-OFFER-ARCHITECTURE.md` (v2.1.0). Do not invent pricing.
...
11. **Duplicate repo warning:** `C:\Dev\00_core\stratanoble-site` is a mirror/clone of this repo. The canonical location is `C:\Dev\10_products\StrataNoble`.
