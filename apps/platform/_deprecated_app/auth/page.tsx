    ...
    <Container className="min-h-screen flex items-center justify-center py-12">
      <div className="w-full max-w-md">
        ...
        <Card className="p-6">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <Input id="password" type={showPassword ? 'text' : 'password'} value={password} onChange={(e) => setPassword(e.target.value)} className="pl-10 pr-12" placeholder="Enter your password" required />
          ...
          <div className="mt-6 text-center">
            <p className="text-gray-600">
              ...
              <button onClick={() => { setIsLogin(!isLogin); setError(null) }} className="text-blue-600 hover:text-blue-500 font-medium">
        ...
        <div className="mt-8 text-center">
          <p className="text-sm text-gray-500">Part of the <span className="font-medium">Strata Noble</span> ecosystem</p>
        </div>
      </div>
    </Container>
  )
