  ...
  return (
    <div className="min-h-screen bg-white">
      <div className="container mx-auto px-4 py-16 max-w-4xl">
        <h1 className="text-4xl font-bold text-command-navy mb-8">Cookie Policy</h1>
        ...
        <div className="prose prose-lg max-w-none">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-command-navy mb-4">What Are Cookies</h2>
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-command-navy mb-4">How We Use Cookies</h2>
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-command-navy mb-4">Types of Cookies We Use</h2>

            <div className="mb-6">
              <h3 className="text-xl font-semibold text-command-navy mb-2">Session Cookies</h3>
              <p className="text-gray-700 leading-relaxed">
            ...
            <div className="mb-6">
              <h3 className="text-xl font-semibold text-command-navy mb-2">Persistent Cookies</h3>
              <p className="text-gray-700 leading-relaxed">
            ...
            <div className="mb-6">
              <h3 className="text-xl font-semibold text-command-navy mb-2">Third-Party Cookies</h3>
              <p className="text-gray-700 leading-relaxed">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-command-navy mb-4">Managing Cookies</h2>
            <p className="text-gray-700 leading-relaxed mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-command-navy mb-4">Cookie Duration</h2>
            <div className="overflow-x-auto">
              <table className="min-w-full border border-slate-grey/30">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-command-navy mb-4">Updates to This Policy</h2>
            <p className="text-gray-700 leading-relaxed">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-command-navy mb-4">Contact Us</h2>
            <p className="text-gray-700 leading-relaxed">
              If you have questions about our use of cookies, please contact us at{' '}
              <a href="mailto:privacy@stratanoble.com" className="text-forest-green hover:text-forest-green">
