  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 max-w-5xl mx-auto">
        <h2 className="text-2xl font-bold text-command-navy mb-8">Where it breaks first</h2>
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
          {v.pains.map((pain, idx) => (
            <motion.div
              ...
              className="border border-slate-grey/25 rounded-xl p-6 bg-white shadow-sm"
            >
              <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-primary/10 text-primary mb-3">
                <pain.Icon className="h-5 w-5" aria-hidden />
              </div>
              <h3 className="font-bold text-command-navy">{pain.title}</h3>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-muted/30 border-y border-slate-grey/20">
        <div className="max-w-3xl mx-auto">
          <h2 className="text-2xl font-bold text-command-navy mb-4">What we install</h2>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 max-w-3xl mx-auto">
        <h2 className="text-2xl font-bold text-command-navy mb-6">What this looks like</h2>
        <article className="rounded-xl border border-slate-grey/25 border-t-4 border-t-primary bg-white p-8 shadow-sm">
          ...
          <span className="inline-block mt-4 text-xs font-medium bg-field-sage/15 text-forest-green px-2.5 py-1 rounded-full">
            {v.scenario.timeline}
          </span>
          <div className="mt-6 space-y-4 text-sm">
            <div>
              <p className="font-semibold text-command-navy">Problem</p>
              <p className="text-muted-foreground mt-1 leading-relaxed">{v.scenario.problem}</p>
            </div>
            <div>
              <p className="font-semibold text-command-navy">Fix</p>
              <p className="text-muted-foreground mt-1 leading-relaxed">{v.scenario.fix}</p>
            </div>
            <div>
              <p className="font-semibold text-command-navy">Result</p>
      ...
      <section className="py-12 px-4 max-w-3xl mx-auto">
        <h2 className="text-xl font-bold text-command-navy mb-3">Recommended path</h2>
        <p className="text-muted-foreground leading-relaxed">{v.offerPath}</p>
      </section>

      <section className="py-16 px-4 bg-command-navy text-white">
        <div className="max-w-3xl mx-auto text-center space-y-6">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              href={v.primaryHref}
              className="inline-flex justify-center items-center rounded-lg px-8 py-4 font-semibold bg-forest-green text-white hover:shadow-lg transition-shadow"
            >
              {v.primaryCta}
            </Link>
            <Link
