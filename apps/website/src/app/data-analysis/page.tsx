...
function InquiryForm() {
  ...
  const {
    ...
    formType: 'analysis',
    onSuccess: () => {
      router.push('/thanks?src=analysis');
    }
  });
    ...
    <div className="bg-white/10 backdrop-blur-xl border border-white/20 rounded-2xl p-6">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <button
          ...
          className="w-full bg-[#50C878] hover:bg-[#3DB067] transition-colors text-white font-medium rounded-lg py-3 px-6 disabled:opacity-50 disabled:cursor-not-allowed"
        >
          {isSubmitting ? 'Submitting...' : 'Request Sample Analysis'}
        </button>
      </form>
      {error && (
    ...
    <main className="min-h-screen bg-gradient-to-br from-[#003366] via-[#004080] to-[#002244] pt-20">
      <div className="py-24 sm:py-32">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {/* Cross-sell Section */}
          <div className="mt-16 bg-white/5 backdrop-blur-xl border border-white/20 rounded-2xl p-8">
            <h2 className="text-2xl font-bold text-white text-center mb-6">Need More Than Data Analysis?</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="text-center">
                <div className="w-12 h-12 bg-[#50C878]/20 rounded-full flex items-center justify-center mx-auto mb-4">
                  <span className="text-[#50C878] text-2xl">💡</span>
                </div>
                <h3 className="text-white font-semibold mb-2">Strategy & Execution</h3>
                <p className="text-[#C0C0C0] text-sm mb-4">
                  Turn your data insights into actionable business strategy with our Solution Services.
                </p>
                <a
                  href="/services"
                  className="inline-block px-4 py-2 bg-[#50C878] hover:bg-[#3DB067] text-white text-sm font-medium rounded-lg transition-colors"
                >
                  Learn More
                </a>
              </div>
              <div className="text-center">
                ...
                <h3 className="text-white font-semibold mb-2">Brand & Digital</h3>
                <p className="text-[#C0C0C0] text-sm mb-4">
                  Build a strong digital presence to showcase your optimized operations and attract more customers.
                </p>
                <a
                  href="/services/brand-digital"
                  className="inline-block px-4 py-2 bg-transparent hover:bg-white/10 text-white text-sm font-medium rounded-lg border border-white/30 transition-colors"
                >
                  Explore Packages
                </a>
              </div>
