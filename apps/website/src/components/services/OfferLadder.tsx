...
const SUBTITLES: Record<string, string> = {
  ...
  '48-hour-fix': 'One broken process, fixed and verified in 48 hours',
  'process-improvement-sprint': 'Rebuild one broken process in 10 business days',
  'service-system-buildout': 'Core service infrastructure installed in 14 days',
    ...
    <section className="bg-white px-4 py-16 md:py-20">
      <div className="mx-auto max-w-6xl">
        ...
        <p className="mx-auto mt-3 max-w-2xl text-center text-slate-600">
          Scoped, fixed-price engagements. Every engagement starts with a free 30-minute diagnostic call.
        </p>
        <div className="mt-12 grid gap-8 md:grid-cols-2 xl:grid-cols-3">
          <article className="flex flex-col rounded-2xl border border-slate-200 bg-slate-50 p-8 shadow-sm">
            ...
            <p className="mt-4 flex-grow text-sm leading-relaxed text-slate-600">
              A 30-minute call to review how your business operates, identify where it breaks,
              and map a path forward before any money changes hands.
            </p>
