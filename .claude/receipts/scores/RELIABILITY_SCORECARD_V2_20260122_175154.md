...
**Generated:** 2026-01-22T17:51:54.548327
...
==========================================================================
RELIABILITY METRICS (24h window: 2026-01-21T17:51 - 2026-01-22T17:51)
==========================================================================
...
```sql
SELECT COUNT(*) FROM queue WHERE intent != 'TEST' AND phase IN ('validate','test','build') AND run_outcome != 'BLOCKED' AND exception_code != 'ENV_TOOLING_UNAVAILABLE'
-- Total: 41 jobs
```
...
{
  "window": {
    "start_time": "2026-01-21T17:51:54.547274",
    "end_time": "2026-01-22T17:51:54.547274",
    "hours": 24
  },
  "ops": {
