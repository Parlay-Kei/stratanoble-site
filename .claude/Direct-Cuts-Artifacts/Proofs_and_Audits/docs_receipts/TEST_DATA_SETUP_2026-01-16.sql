-- E2E TEST DATA SETUP FOR STAGING
-- Project: wgxiiefnmaxfxfoqsbwl (staging only)
-- Date: 2026-01-16
-- WARNING: Run this ONLY in staging, NEVER in production
...
-- ================================================
-- BARBER A: ENTITLED (can accept bookings)
-- ================================================
...
VALUES (
  ...
  true,
  'Barber A Shop',
  'Test barber with active subscription',
  NOW()
);

-- Give Barber A an ACTIVE subscription
...
-- Could have subscription but doesn't matter - inactive blocks bookings
INSERT INTO barber_subscriptions (
  barber_id,
  status,
  stripe_customer_id,
...
-- Check barber subscription status
SELECT
  b.id as barber_id,
  u.full_name,
  b.is_active,
...
-- Check guest identity
SELECT id, phone, email, verified, verification_code
