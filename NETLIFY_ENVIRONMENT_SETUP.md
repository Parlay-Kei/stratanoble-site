...
4. **Add each variable:**
   ...
   - Paste variable value (e.g., `https://REDACTED.supabase.co`)
...
netlify env:set NEXT_PUBLIC_SUPABASE_URL "https://REDACTED.supabase.co"
netlify env:set NEXT_PUBLIC_SUPABASE_ANON_KEY "REDACTED_ANON_KEY"
netlify env:set SUPABASE_SERVICE_ROLE_KEY "REDACTED_SERVICE_ROLE_KEY"
