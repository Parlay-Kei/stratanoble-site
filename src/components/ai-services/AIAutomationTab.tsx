...
import { Rocket, BarChart3, ArrowRight, Zap } from 'lucide-react';
import { cn } from '@/lib/ui-utils';

const offerings = [
  {
    icon: Rocket,
    title: 'Solo-Preneur Autopilot',
    description: 'Automate your business operations with AI to run your business on autopilot.',
    features: [
      ...
      <Container>
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <AnimatedText as="p" className="text-xl text-primary/80 leading-relaxed">
            Streamline your operations and make data-driven decisions with AI automation.
          </AnimatedText>
        </div>
        ...
        >
          <p className="text-primary/80 max-w-2xl mx-auto">
            Ready to automate your business? Book a free strategy call to discover how AI can
