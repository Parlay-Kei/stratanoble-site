        ...
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          ...
          <div className="space-y-8 xl:col-span-1">
            ...
            <p className="text-sm leading-6 text-navy-300">
              Transforming passion into profit through strategic excellence and proven business frameworks.
            </p>
                ...
                <ul role="list" className="mt-6 space-y-4">
                  {navigation.services.map((item) => (
                    <li key={item.name}>
                      <Link
                        href={item.href}
                        className="text-sm leading-6 text-navy-300 hover:text-white"
                  >
                        {item.name}
                      </Link>
                </li>
              ...
              <div className="mt-10 md:mt-0">
                ...
                <form className="mt-6 sm:flex sm:max-w-md">
                  ...
                  <div className="mt-4 sm:ml-4 sm:mt-0 sm:flex-shrink-0">
                    <button
                      type="submit"
                      className="flex w-full items-center justify-center rounded-md bg-emerald-500 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-emerald-400 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-emerald-500"
                    >
                      Subscribe
                    </button>
                  </div>
