    ...
    <section className="relative overflow-hidden bg-gradient-to-br from-navy to-brand-emerald py-24 sm:py-32">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-4xl text-center">
          {/* Enhanced Tagline Banner - Using CSS animations instead of Framer Motion */}
          <div className="mb-8 inline-flex items-center rounded-full bg-emerald-50 px-4 py-2 text-sm font-medium text-emerald-700 ring-1 ring-inset ring-emerald-600/20 animate-fade-in-up">
            <SparklesIcon className="mr-2 h-4 w-4" />
            Passion to Prosperity
            <SparklesIcon className="ml-2 h-4 w-4" />
          </div>

          {/* Enhanced Main Headline - Using CSS animations */}
          <h1 className="text-4xl font-bold tracking-tight text-brand-light sm:text-6xl lg:text-7xl animate-fade-in-up animation-delay-100">
            Transform Your{' '}
          ...
          <p className="mt-6 text-lg leading-8 text-brand-light sm:text-xl max-w-3xl mx-auto animate-fade-in-up animation-delay-200">
          ...
          {/* Enhanced Dual-State CTA Buttons with CSS hover effects */}
          <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4 animate-fade-in-up animation-delay-300">
            ...
            <Link
              ...
              className="btn-primary btn-lg group w-full sm:w-auto shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 active:scale-95"
            ...
            <Link
              ...
              className="btn-outline btn-lg group w-full sm:w-auto border-2 transition-all duration-300 hover:scale-105 active:scale-95"
          ...
          <div className="mt-16 flex flex-wrap items-center justify-center gap-x-8 gap-y-4 text-sm text-brand-light animate-fade-in-up animation-delay-400">
